...
* xref:maui:ROOT:examples.adoc#example-data[Data processing example]
* xref:maui:ROOT:examples.adoc#example-peaks[Peak detection example]
* xref:maui:ROOT:examples.adoc#example-eis-fit[EIS fit example]
...
Examples of the peak detection are also provided in the xref:maui:ROOT:examples.adoc#example-data[Data processing] and xref:maui:ROOT:examples.adoc#example-peaks[Peak detection] example projects.
...
The xref:maui:ROOT:examples.adoc#example-eis-fit[EIS fit example] project also demonstrates how to use the equivalent circuit fitting.
