...
----
method = new AmperometricDetection();
method.MuxMethod = MuxMethod.Sequentially;  <1>

method.UseMuxChannel = new bool[] {  <2>
    true, false, true, false, true, false, false, false  <3>
};
----
<1> Set sequential mux method
<2> Create an array of booleans indicating on which channels you would like to measure
<3> Measure sequentially on channel 1, 3 and 5
...
----
method = new AmperometricDetection();
method.MuxMethod = MuxMethod.Alternatingly;  <1>

method.UseMuxChannel = new bool[] {  <2>
    true, true, true, false, false, false, false, false  <3>
};
----
<1> Set alternating mux method
<2> Create an array of booleans indicating on which channels you would like to measure
<3> Measure alternatingly on channel 1, 2, and 3
