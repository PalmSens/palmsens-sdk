...
image::start:dotnet:pssession.png[Data in pssession files]
...
See also: xref:maui:ROOT:examples#example-internal[Internal storage example].
...
For a practical application, please refer to the xref:maui:ROOT:examples.adoc#example-internal[Internal storage example].
