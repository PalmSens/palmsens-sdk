...
These wrap some of the classes and functions in the xref:start:dotnet:techniques.adoc[.NET SDK] and make them accessible through Matlab.
...
These wrap some of the Palmsens xref:start:dotnet:techniques.adoc[.NET internal data structures] to make them more accessible in Matlab.
