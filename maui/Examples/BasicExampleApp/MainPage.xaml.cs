...
using PalmSensBasicExample.Services;
...
namespace PalmSensBasicExample
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            var model = new PlotModel { Title = "LSV plot" };
            ...
            {
                scatterSeries.Points.Add(new ScatterPoint(point.Potential, point.Current, 3, 200));
            }
