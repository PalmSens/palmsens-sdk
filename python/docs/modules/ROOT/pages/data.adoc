...
The xref:{api-data}[`ps.data`] submodule contains wrappers for the PyPalmSens .NET SDK libraries.
...
For more information, see the xref:{api-data}#pypalmsens.data.Measurement[Measurement reference].
...
Sometimes the parameters need to be tuned, see xref:{api-data}#pypalmsens.data.Curve.find_peaks[`.find_peaks()`] for more information.
====

You can do filtering using xref:{api-data}#pypalmsens.data.Curve.smooth[`.smooth()`]. Note that this updates the curve in-place.
...
For more information, see the xref:{api-data}#pypalmsens.data.Curve[Curve reference].
...
For more information, see the xref:{api-data}#pypalmsens.data.Peak[Peak reference].
...
For more information, see the xref:{api-data}#pypalmsens.data.DataSet[DataSet reference].
...
For more information, see the xref:{api-data}#pypalmsens.data.DataArray[DataArray reference].
...
For more information, see the xref:{api-data}#pypalmsens.data.EISData[EISData reference].
