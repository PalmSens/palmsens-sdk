...
* Optional: https://ftdichip.com/drivers/d2xx-drivers/[FTDI d2xx drivers].
  - For a list of devices with an FTDI chip, see the <<compatibility,Compatibility table>>.
...
To see if your device needs the FTDI drivers, see the <<compatibility,Compatibility table>>.
...
| Generic FTDI footnote:linuxftdi[See xref:installation.adoc#req-linux[the installation instructions] for more info.]

| Palmsens2
| 4.4
| PalmSens FTDI footnote:psdrivers[]
| Generic FTDI footnote:linuxftdi[]
