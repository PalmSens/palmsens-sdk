...
The xref:{api-inst}#pypalmsens.InstrumentManager[`InstrumentManager()`] and xref:{api-inst}#pypalmsens.InstrumentManagerAsync[`InstrumentManagerAsync()`] class are wrappers around our .NET libraries which make it possible to connect to and control PalmSens instruments from Python.
...
[{'index': 1, 'x': 0.0,  'x_unit': 's', 'x_type': 'Time', 'y': -305.055, 'y_unit': 'µA', 'y_type': 'Current'}]
[{'index': 2, 'x': 0.01, 'x_unit': 's', 'x_type': 'Time', 'y': -731.741, 'y_unit': 'µA', 'y_type': 'Current'}]
[{'index': 3, 'x': 0.02, 'x_unit': 's', 'x_type': 'Time', 'y': -751.552, 'y_unit': 'µA', 'y_type': 'Current'}]
...
----
...
...         print(point)
...
>>> manager.measure(method, callback=new_data_callback)
{'index': 1, 'x': 0.00, 'x_unit': 's', 'x_type': 'Time', 'y': -305.055, 'y_unit': 'µA', 'y_type': 'Current'}
{'index': 2, 'x': 0.01, 'x_unit': 's', 'x_type': 'Time', 'y': -740.935, 'y_unit': 'µA', 'y_type': 'Current'}
{'index': 3, 'x': 0.02, 'x_unit': 's', 'x_type': 'Time', 'y': -750.604, 'y_unit': 'µA', 'y_type': 'Current'}
...
----
...
----
>>> async with ps.InstrumentPoolAsync(instruments) as pool:
...    results = await pool.measure(method, callback=new_data_callback)
----
