= Methods
:api-techniques: api:attachment$techniques/index.html
...
- xref:{api-techniques}#pypalmsens.LinearSweepVoltammetry[Linear Sweep Voltammetry]
- xref:{api-techniques}#pypalmsens.CyclicVoltammetry[Cyclic Voltammetry]
- xref:{api-techniques}#pypalmsens.FastCyclicVoltammetry[Fast Cyclic Voltammetry]
- xref:{api-techniques}#pypalmsens.AcVoltammetry[AC Voltammetry]

Pulsed Techniques::

- xref:{api-techniques}#pypalmsens.DifferentialPulseVoltammetry[Differential Pulse Voltammetry]
- xref:{api-techniques}#pypalmsens.SquareWaveVoltammetry[Square Wave Voltammetry]
- xref:{api-techniques}#pypalmsens.NormalPulseVoltammetry[Normal Pulse Voltammetry]

Amperometric Techniques::

- xref:{api-techniques}#pypalmsens.Chronoamperometry[Chronoamperometry]
- xref:{api-techniques}#pypalmsens.MultistepAmperometry[Multistep Amperometry]
- xref:{api-techniques}#pypalmsens.FastAmperometry[Fast Amperometry]
- xref:{api-techniques}#pypalmsens.PulsedAmperometricDetection[Pulsed Amperometric Detection]
- xref:{api-techniques}#pypalmsens.MultiplePulseAmperometry[Multiple Pulse Amperometry]

Potentiometric Techniques::

- xref:{api-techniques}#pypalmsens.OpenCircuitPotentiometry[Open Circuit Potentiometry]
- xref:{api-techniques}#pypalmsens.Chronopotentiometry[Chronopotentiometry]
- xref:{api-techniques}#pypalmsens.LinearSweepPotentiometry[Linear Sweep Potentiometry]
- xref:{api-techniques}#pypalmsens.MultistepPotentiometry[Multistep Potentiometry]
- xref:{api-techniques}#pypalmsens.StrippingChronopotentiometry[Stripping Chronopotentiometry]

Coulometric techniques::

- xref:{api-techniques}#pypalmsens.Chronocoulometry[Chronocoulometry]

Other::

- xref:{api-techniques}#pypalmsens.ImpedanceSpectroscopy[Impedance Spectroscopy]
- xref:{api-techniques}#pypalmsens.FastImpedanceSpectroscopy[Fast Impedance Spectroscopy]
- xref:{api-techniques}#pypalmsens.GalvanostaticImpedanceSpectroscopy[Galvanostatic Impedance Spectroscopy]
- xref:{api-techniques}#pypalmsens.FastGalvanostaticImpedanceSpectroscopy[Fast Galvanostatic Impedance Spectroscopy]
- xref:{api-techniques}#pypalmsens.MixedMode[Mixed Mode]
- xref:{api-techniques}#pypalmsens.MethodScript[Method Script]
...
For a full listing, see the xref:api:attachment$settings/index.html[method settings API reference].
