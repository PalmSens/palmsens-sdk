...
class AutoPeak(Peak):
    ...
    @DateTime.setter
    def DateTime(self, value: typing.Optional[DateTime]) -> typing.Optional[DateTime]: ...
    @property
    def Label(self) -> str: ...
    @property
...
class CFALevelList(IList_1[Level]):
    ...
    def Curve(self) -> Curve: ...
    @Curve.setter
    def Curve(self, value: Curve) -> Curve: ...
    @property
    ...
    def __setitem__(self, i: int, value: Level) -> None: ...
...
class PeakList(IEnumerable_1[Peak]):
    ...
    def __setitem__(self, i: int, value: Peak) -> None: ...
