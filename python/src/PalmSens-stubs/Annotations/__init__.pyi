...
class AspTypePropertyAttribute(Attribute):
    ...
    @CreateConstructorReferences.setter
    def CreateConstructorReferences(self, value: bool) -> bool: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class AssertionConditionAttribute(Attribute):
    ...
    def ConditionType(self, value: AssertionConditionType) -> AssertionConditionType: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class CollectionAccessAttribute(Attribute):
    ...
    @CollectionAccessType.setter
    def CollectionAccessType(self, value: CollectionAccessType) -> CollectionAccessType: ...
    @property
    def TypeId(self) -> typing.Any: ...
...
class ContractAnnotationAttribute(Attribute):
    ...
    @ForceFullStates.setter
    def ForceFullStates(self, value: bool) -> bool: ...
    @property
    def TypeId(self) -> typing.Any: ...
