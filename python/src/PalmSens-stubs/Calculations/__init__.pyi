...
class MatrixObj_1(typing.Generic[MatrixObj_1_T], IEquatable_1[MatrixObj_1[MatrixObj_1_T]], abc.ABC):
    ...
    def __getitem__(self, row: int, column: int) -> MatrixObj_1_T: ...
    def __setitem__(self, row: int, column: int, value: MatrixObj_1_T) -> None: ...
...
class SparseMatrix_1(typing.Generic[SparseMatrix_1_T], MatrixObj_1[SparseMatrix_1_T]):
    ...
    def __getitem__(self, row: int, column: int) -> SparseMatrix_1_T: ...
    def __setitem__(self, row: int, column: int, value: SparseMatrix_1_T) -> None: ...
