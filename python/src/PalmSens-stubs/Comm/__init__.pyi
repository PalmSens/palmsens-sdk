...
from PalmSens import Measurement, Method, CurrentRange, MeasType, PotentialRange, TaskBarrier, PotentionstatChannels, MethodScript
...
from System import TimeSpan, DateTime, MulticastDelegate, IAsyncResult, AsyncCallback, Exception, Array_1, Enum, Action, Func_1, ValueTuple_3, IDisposable, EventArgs
from System.Threading.Tasks import Task, Task_1, TaskScheduler, TaskCompletionSource
...
from System.Threading import SemaphoreSlim, CancellationToken
...
class ClientConnection(INotifyPropertyChanged):
    ...
    @classmethod
    @ConnectedDeviceCapabilities.setter
    def ConnectedDeviceCapabilities(cls, value: DeviceCapabilities) -> DeviceCapabilities: ...
    @property
...
class ClientConnectionMS(ClientConnection):
    ...
    def CheckDeviceStatus(self, errorStr: clr.Reference[str]) -> bool: ...
    def CheckDeviceStatusAsync(self) -> Task_1[str]: ...
    def CheckHardwareSyncCableAsync(self, method: Method, finshedTaskCompletionSource: TaskCompletionSource, cancellationToken: CancellationToken) -> Task: ...
    def ClearDeviceFiles(self) -> None: ...
    def ClearDeviceFilesAsync(self) -> Task: ...
    def DeleteDeviceFile(self, filePath: str) -> None: ...
    def DeleteDeviceFileAsync(self, filePath: str) -> Task: ...
    ...
    def IdentifyAsync(self, delay: int, numberOfBlinks: int) -> Task: ...
    def LoadDeviceFile(self, file: DeviceFile) -> Measurement: ...
...
class ClientConnectionNexus(ClientConnectionMS):
    ...
    def ReloadDataAsync(self) -> Task: ...
    def SendModeCellStateRanges(self, mode: EnumMode, cellOn: bool, cr: CurrentRange, pr: PotentialRange = ...) -> None: ...
    def SetHardwareSynchronizationRoleAsync(self, isMaster: bool) -> Task: ...
    def SetMuxSettings(self, type: MuxType, sett: Method.MuxSettings) -> None: ...
    def SetMuxSettingsAsync(self, type: MuxType, sett: Method.MuxSettings) -> Task: ...
    def SetSerial(self, serial: DeviceSerialV2) -> None: ...
    def SetSerialAsync(self, serial: DeviceSerialV2) -> Task: ...
...
class enumDeviceType(typing.SupportsInt):
    ...
    EmStatPicoExtended : enumDeviceType # 22
...
class MeasureVersusOCP:
    ...
    @Measurement.setter
    def Measurement(self, value: Measurement) -> Measurement: ...
    @property
    def Method(self) -> Method: ...
    @Method.setter
    def Method(self, value: Method) -> Method: ...
