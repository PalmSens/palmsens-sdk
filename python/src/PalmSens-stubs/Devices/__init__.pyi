...
from System.Threading import Thread, CancellationToken, SemaphoreSlim
...
class DefaultCapabilities(DeviceCapabilities):
    ...
    @CellTypes.setter
    def CellTypes(self, value: Array_1[str]) -> Array_1[str]: ...
    @property
    ...
    def HardwareRevision(self, value: int) -> int: ...
    @property
    def HardwareSynchronizationGroupId(self) -> str: ...
    @HardwareSynchronizationGroupId.setter
    def HardwareSynchronizationGroupId(self, value: str) -> str: ...
    @property
    ...
    @property
    def IsHardwareSynchronizationMaster(self) -> bool: ...
    @IsHardwareSynchronizationMaster.setter
    def IsHardwareSynchronizationMaster(self, value: bool) -> bool: ...
    @property
    ...
    @MaxVAux.setter
    def MaxVAux(self, value: float) -> float: ...
    @property
    ...
    @SupportedCommands.setter
    def SupportedCommands(self, value: str) -> str: ...
    @property
    def SupportedMethods(self) -> Array_1[int]: ...
    @SupportedMethods.setter
    def SupportedMethods(self, value: Array_1[int]) -> Array_1[int]: ...
    @property
...
class Device(abc.ABC):
    ...
    @Retries.setter
    def Retries(self, value: int) -> int: ...
    @property
    ...
    def GetVersionStringAsync(self, cancellationToken: CancellationToken = ...) -> Task_1[Array_1[str]]: ...
    @staticmethod
...
class EmStat4BLCapabilities(EmStat4CommonCapabilities):
    ...
    @ConnDescription.setter
    def ConnDescription(self, value: str) -> str: ...
    @property
    def DACAuxiliary(self) -> AnalogComponent: ...
    @property
    def DACBiPot(self) -> AnalogComponent: ...
    ...
    @MethodSCRIPTVersion.setter
    def MethodSCRIPTVersion(self, value: str) -> str: ...
    @property
    def MinADIntervalTime(self) -> float: ...
    @property
    def MinCurrent(self) -> float: ...
    ...
    @SupportedDigitalInputLineMask.setter
    def SupportedDigitalInputLineMask(self, value: int) -> int: ...
    @property
    def SupportedDigitalOutputLineMask(self) -> int: ...
    @SupportedDigitalOutputLineMask.setter
    def SupportedDigitalOutputLineMask(self, value: int) -> int: ...
    @property
    def SupportedMethods(self) -> Array_1[int]: ...
    @SupportedMethods.setter
    def SupportedMethods(self, value: Array_1[int]) -> Array_1[int]: ...
    ...
    @SupportedWakeOnTriggers.setter
    def SupportedWakeOnTriggers(self, value: WakeOnTriggers) -> WakeOnTriggers: ...
    @property
    def SupportsAdvancedTriggering(self) -> bool: ...
    @property
    def SupportsAdvancedTriggeringOnDelay(self) -> bool: ...
...
class EmStat4CommonCapabilities(MethodScriptDeviceCapabilities, INonVolatileMemoryMETHODScriptCapabilities, IHibernationCapabilities):
    ...
    def OverrideSupportedDigitalInputLineMask(self, mask: int) -> None: ...
    def OverrideSupportedDigitalOutputLineMask(self, mask: int) -> None: ...
    def PotentialRangeToGainSetting(self, range: PotentialRanges) -> int: ...
...
class EmStatPicoExtendedCapabilities(EmStatPicoCapabilities):
    def __init__(self) -> None: ...
    BiPotCalibration : PalmSensBiPotCalibration
    CustomDeviceID : str
    EISCalibration : EISCalibration
