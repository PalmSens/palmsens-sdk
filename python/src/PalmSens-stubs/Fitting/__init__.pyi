...
class FitOptionsCircuit(FitOptions):
    ...
    def EnableMinimunDeltaParameters(self, value: bool) -> bool: ...
    @property
    def FitType(self) -> FitOptionsCircuit.FitTypes: ...
    @FitType.setter
    def FitType(self, value: FitOptionsCircuit.FitTypes) -> FitOptionsCircuit.FitTypes: ...
    @property
    def InitialParameters(self) -> Array_1[float]: ...
    @InitialParameters.setter
    def InitialParameters(self, value: Array_1[float]) -> Array_1[float]: ...
    ...
    @property
    def Weight(self) -> FitOptionsCircuit.Weighting: ...
    @Weight.setter
    def Weight(self, value: FitOptionsCircuit.Weighting) -> FitOptionsCircuit.Weighting: ...
    @property
    def XData(self) -> Array_1[float]: ...
    @property
    def YData(self) -> Array_1[float]: ...
