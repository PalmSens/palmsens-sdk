...
from System import Version, Array_1, MulticastDelegate, IAsyncResult, AsyncCallback, EventArgs, IDisposable
from PalmSens.Data import DataArray, DataArrayType, EnumDirection, EnumAxes, ArrayDataAddedEventArgs, DataSetEIS, IDataValue, CurrentReading
...
class Curve(Plottable):
    ...
    @XAxisDataArray.setter
    def XAxisDataArray(self, value: DataArray) -> DataArray: ...
    @property
    ...
    @YAxisDataArray.setter
    def YAxisDataArray(self, value: DataArray) -> DataArray: ...
    @property
    def YUnit(self) -> Unit: ...
    @property
    def ZUnit(self) -> Unit: ...
...
class EISDataSubScan(EISData):
    ...
    @ParentEISData.setter
    def ParentEISData(self, value: EISData) -> EISData: ...
    @property
    def PlotMode(self) -> EISPlotModes: ...
    @property
    def SavedToFile(self) -> bool: ...
...
class VisualSettings(IDisposable):
    ...
    @property
    def SymbolType(self) -> VisualSettings.Symbol: ...
    @SymbolType.setter
    def SymbolType(self, value: VisualSettings.Symbol) -> VisualSettings.Symbol: ...
    @property
