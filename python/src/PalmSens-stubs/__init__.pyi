...
from PalmSens.Comm import ActiveMeasurement, MeasureVersusOCP, enumDeviceType, ClientConnectionMS, ClientConnection, Buffer, MuxType
...
class CalibrationCurve(Curve):
    ...
    @OCPValue.setter
    def OCPValue(self, value: float) -> float: ...
    @property
...
class CurrentRange(IRange, IComparable):
    ...
    @Gain.setter
    def Gain(self, value: typing.Optional[int]) -> typing.Optional[int]: ...
    @property
...
class Measurement(IDisposable, IEnumerable):
    ...
    def __init__(self, bag: JsonBag, coreVersion: Version) -> None: ...
    @typing.overload
    def __init__(self, dataSet: DataSetCommon) -> None: ...
    @typing.overload
    def __init__(self, m: Method) -> None: ...
    @typing.overload
    def __init__(self, m: Method, dataSet: DataSetCommon) -> None: ...
    Channel : int
    @property
    def BlankCurve(self) -> Curve: ...
    @BlankCurve.setter
...
class MethodScript(EncodedMethod):
    ...
    def ConnMS(self) -> ClientConnectionMS: ...
    @ConnMS.setter
    def ConnMS(self, value: ClientConnectionMS) -> ClientConnectionMS: ...
    @property
    def DeviceFileName(self) -> str: ...
    @property
    def ForEditor(self) -> bool: ...
    @ForEditor.setter
    def ForEditor(self, value: bool) -> bool: ...
    @property
    def Hibernate(self) -> bool: ...
    @Hibernate.setter
    def Hibernate(self, value: bool) -> bool: ...
...
class MuxModel(typing.SupportsInt):
    ...
    MUX16 : MuxModel # 2
    MUX8R2 : MuxModel # 3
    PicoMUX16 : MuxModel # 4
    PicoMUX256 : MuxModel # 5
...
class PotentialRange(IRange, IComparable):
    ...
    @PR.setter
    def PR(self, value: PotentialRanges) -> PotentialRanges: ...
    def CompareTo(self, that: typing.Any) -> int: ...
    def Equals(self, obj: typing.Any) -> bool: ...
...
class PSThread:
    ...
    class ThreadPriorities(abc.ABC):
        ...
        @classmethod
        @AboveNormal.setter
        def AboveNormal(cls, value: int) -> int: ...
        @classmethod
        @property
        def BelowNormal(cls) -> int: ...
        @classmethod
        @BelowNormal.setter
        def BelowNormal(cls, value: int) -> int: ...
        @classmethod
        @property
        def Highest(cls) -> int: ...
        @classmethod
        @Highest.setter
        def Highest(cls, value: int) -> int: ...
        @classmethod
        @property
        def Lowest(cls) -> int: ...
        @classmethod
        @Lowest.setter
        def Lowest(cls, value: int) -> int: ...
        @classmethod
        @property
        def Normal(cls) -> int: ...
        @classmethod
        @Normal.setter
        def Normal(cls, value: int) -> int: ...
...
class ScriptLine:
    ...
    def Indentation(self) -> str: ...
    @Indentation.setter
    def Indentation(self, value: str) -> str: ...
