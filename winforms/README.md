...
<p align="center">
    <a href="https://dev.palmsens.com/winforms/latest" target="_blank">
        <picture>
...
# WinForms SDK for PalmSens devices

With this WinForms SDK you develop Windows applications in Visual Studio using [WinForms](https://learn.microsoft.com/en-us/dotnet/desktop/wpf/overview/).
