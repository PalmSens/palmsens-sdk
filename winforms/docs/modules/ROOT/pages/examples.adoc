...
https://github.com/palmsens/palmsens-sdk/blob/main/winforms/Examples/BasicExample[Link to the code]
--
...
https://github.com/palmsens/palmsens-sdk/blob/main/winforms/Examples/MultiChannelExample[Link to the code]
--
