...
https://github.com/palmsens/palmsens-sdk/blob/main/wpf/Examples/BasicExample[Link to the code]
--
...
https://github.com/palmsens/palmsens-sdk/blob/main/wpf/Examples/MultiChannelExample[Link to the code]
--
